...
var ErrorBoundaryFallback = function ErrorBoundaryFallback(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    "p-id": "845",
    fill: "#cdcdcd"
  })), /*#__PURE__*/React.createElement("h3", null, "Oops! Something went wrong."));
};
...
var ParamFnBuilder = function ParamFnBuilder(_ref) {
  ...
  var _useContext = React.useContext(theme.context),
  ...
  var _useState5 = React.useState(defaultFnData),
      _useState6 = _slicedToArray(_useState5, 2),
      fnData = _useState6[0],
      setFnData = _useState6[1];

  var _useCopy = theme.useCopy(),
  ...
  return /*#__PURE__*/React__default['default'].createElement(ErrorBoundary, null, paramArr.length && /*#__PURE__*/React__default['default'].createElement("div", {
    className: "markdown param-builder"
  }, /*#__PURE__*/React__default['default'].createElement("p", {
    className: "title"
  }, "".concat(identifier, "--").concat(expt)), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "alert error ".concat(modalConfig.modalState ? 'show' : 'hidden')
  }, modalConfig.errorMsg), /*#__PURE__*/React__default['default'].createElement("table", null, /*#__PURE__*/React__default['default'].createElement("thead", null, /*#__PURE__*/React__default['default'].createElement("tr", null, /*#__PURE__*/React__default['default'].createElement("th", null, texts.name), /*#__PURE__*/React__default['default'].createElement("th", null, texts.value))), /*#__PURE__*/React__default['default'].createElement("tbody", null, paramArr.map(function (param, idx) {
    return /*#__PURE__*/React__default['default'].createElement("tr", {
      key: param.identifier
    }, /*#__PURE__*/React__default['default'].createElement("td", null, "".concat(param.identifier).concat(param.required ? ' *' : '')), /*#__PURE__*/React__default['default'].createElement("td", null, /*#__PURE__*/React__default['default'].createElement("textarea", Object.assign({
      "data-index": idx,
  ...
  })), /*#__PURE__*/React__default['default'].createElement("tfoot", null, /*#__PURE__*/React__default['default'].createElement("tr", null, /*#__PURE__*/React__default['default'].createElement("td", {
    colSpan: 2
  ...
  }, resData), /*#__PURE__*/React__default['default'].createElement("button", {
...
var FnBuilder = function FnBuilder(_ref) {
  ...
  try {
    var apis = theme.useApiData(identifier);
  ...
  return /*#__PURE__*/React__default['default'].createElement(ErrorBoundary, null, /*#__PURE__*/React__default['default'].createElement("div", {
    className: "markdown"
  }, /*#__PURE__*/React__default['default'].createElement("h2", null, identifier, " \u5728\u7EBF\u8FD0\u884C"), exptsArr.length && exptsArr.reduce(function (expts, _ref2, index) {
    var _ref3 = _slicedToArray(_ref2, 2),
        expt = _ref3[0],
        paramArr = _ref3[1];

    expts.push( /*#__PURE__*/React__default['default'].createElement(ParamFnBuilder, {
...
var APIHelper = function APIHelper() {
  return /*#__PURE__*/React__default['default'].createElement(FnBuilder, {
    identifier: identifier,
    apiRun: apiRun
  });
};
...
var Check = function Check() {
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(FnBuilder, {
